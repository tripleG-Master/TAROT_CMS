...
router.get("/security/ips", controller.showSecurityIps);
router.post("/security/ips/:id/unblock", controller.unblockSecurityIp);
router.post("/security/ips/:id/reset", controller.resetSecurityIp);
